...
void main() {
	...
	position.x += dot(sines, CAST4(1.0)) * g_Strength * 100 * weight * g_DirectionWeights.x;
	position.y += dot(csines, CAST4(1.0)) * g_Strength * 100 * weight * g_DirectionWeights.y;
